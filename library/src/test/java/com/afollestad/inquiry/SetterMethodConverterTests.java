...
public class SetterMethodConverterTests {

    @Test public void test_basic_row_to_values() {
        BasicSetterRow row = new BasicSetterRow("afollestad", 21, true, 100f);
    ...
    @Test public void test_cursor_to_row() {
        ...
        BasicSetterRow row = InquiryConverter.cursorToObject(null, mockCursor, BasicSetterRow.class);
