...
public class Inquiry extends InquiryBase {
    ...
    if (databaseHelper == null) {
      if (databaseName == null || databaseName.trim().isEmpty())
        throw new IllegalStateException(
            "You must initialize your Inquiry instance with a non-null database name.");
  ...
  @Nullable
  FieldDelegate getIdDelegate(Class<?> forClass) {
    ...
    for (FieldDelegate proxy : allProxiesList) {
      if (proxy.isId()) {
        ...
        if (!columnAnnotation.autoIncrement() || !columnAnnotation.primaryKey())
          throw new IllegalStateException(
              "Columns which represent _id columns MUST have autoIncrement() AND primaryKey() enabled.");
        if (proxy.getType() != Long.class && proxy.getType() != long.class)
          throw new IllegalStateException(
              "Columns which represent _id columns MUST be of type Long.");
        idProxy = proxy;
      }
    }
    if (idProxy == null) {
  ...
  @Nullable
  Class<?> getBuilderClass(Class<?> parent) {
  ...
  @Nullable
  Method getBuildMethod(Class<?> parentCls, Class<?> builder) {
  ...
  public static class Builder {
    ...
    public Inquiry build(boolean persist) {
      ...
      if (persist) {
        ...
        else if (instances.containsKey(name)) instances.get(name).destroyInstance();
        instances.put(name, newInstance);
      }

      try {
        if (newInstance.handler == null) newInstance.handler = new Handler();
  ...
  public static Inquiry.Builder newInstance(
      @NonNull Context context, @Nullable String databaseName) {
    return new Inquiry.Builder(context, databaseName);
  }

  @CheckResult
  @NonNull
  public static Inquiry copy(
      @NonNull Inquiry instance, @NonNull String newInstanceName, boolean persist) {
  ...
  @NonNull
  public static Inquiry copy(
      @NonNull Inquiry instance, @NonNull Context newContext, boolean persist) {
  ...
  public void destroyInstance() {
    ...
    if (instanceName != null) {
      if (instances != null) instances.remove(instanceName);
      instanceName = null;
    }
    context = null;
    handler = null;
  ...
  public void dropTable(@NonNull Class<?> rowCls) {
    SQLiteDatabase db =
        new SQLiteHelper(context, databaseName, databaseVersion).getWritableDatabase();
  ...
  public static Inquiry get(@NonNull String instanceName) {
    if (instances == null || !instances.containsKey(instanceName))
      throw new IllegalStateException(
          String.format(
              "No persisted instance found for %s, or it's been garbage collected.", instanceName));
  ...
  @NonNull
  @Deprecated
  public <RowType> Query<RowType, Integer> selectFrom(
      @NonNull String table, @NonNull Class<RowType> rowType) {
  ...
  @NonNull
  public <RowType> Query<RowType, Integer> selectFrom(
      @NonNull Uri contentProviderUri, @NonNull Class<RowType> rowType) {
  ...
  @NonNull
  @Deprecated
  public <RowType> Query<RowType, Long[]> insertInto(
      @NonNull String table, @NonNull Class<RowType> rowType) {
  ...
  @NonNull
  @Deprecated
  public <RowType> Query<RowType, Integer> update(
      @NonNull String table, @NonNull Class<RowType> rowType) {
  ...
  @NonNull
  @Deprecated
  public <RowType> Query<RowType, Integer> deleteFrom(
      @NonNull String table, @NonNull Class<RowType> rowType) {
