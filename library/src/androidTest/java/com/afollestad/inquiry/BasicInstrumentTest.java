...
public class BasicInstrumentTest {
    ...
    @Test public void test_insert_and_query() throws Exception {
        ...
        Person[] query1 = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
        ...
        Person[] query2 = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
                .whereIn("age", 70, 42)
                .sort("name")
                .all();
        ...
        Person[] query3 = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
                .where("age >= 19")
                .where("age <= 42")
                .sort("name")
        ...
        Person[] query4 = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
                .where("age = 19")
                .orWhere("name = ?", "Aidan")
                .sort("name")
        ...
        Person[] query5 = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
                .where("name LIKE ?", "%dan")
                .sort("name")
                .all();
    ...
    @Test public void test_delete() {
        ...
        Person[] query = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
                .sort("name")
                .all();
        assertNotNull(query);
    ...
    @Test public void test_query_foreign_keys() {
        Person[] people = new Person[]{
                new Person("Natalie", 43),
                new Person("Angela", 41)
        };
    ...
    @Test public void test_update_foreign_keys() {
        Person[] people = new Person[]{
                new Person("Natalie", 43),
                new Person("Angela", 41)
        };
        ...
        Inquiry.get(INSTANCE_NAME)
                .update(Person.class)
                .values(queriedPeople)
                .run();

        Person[] queriedPeople2 = Inquiry.get(INSTANCE_NAME)
                .select(Person.class)
                .sort("name")
                .all();
    ...
    @Test public void test_delete_foreign_keys() {
        Person[] people = new Person[]{
                new Person("Natalie", 43),
                new Person("Angela", 41)
        };
