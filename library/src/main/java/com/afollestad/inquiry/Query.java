...
public class Query<RowType, RunReturn> {
  ...
  private void appendWhere(String statement, String[] args, boolean or) {
    ...
    if (Utils.countOccurrences(statement, '?') != argCount)
      throw new IllegalArgumentException(
          "There must be the same amount of args as there is '?' characters in your where statement.");
    if (where == null) where = new StringBuilder();
    if (whereArgs == null) whereArgs = new ArrayList<>(argCount);
    if (where.length() > 0) where.append(or ? " OR " : " AND ");
    where.append(statement);
    if (args != null) Collections.addAll(whereArgs, args);
  }
    ...
    if (contentUri != null) {
      cursor =
          inquiryInstance
              .context
              .getContentResolver()
              .query(contentUri, null, getWhere(), getWhereArgs(), null);
    } else {
      if (inquiryInstance._getDatabase() == null)
        throw new IllegalStateException("Database helper was null.");
      else if (tableName == null) throw new IllegalStateException("Table name was null.");
      cursor =
          inquiryInstance._getDatabase().query(tableName, null, getWhere(), getWhereArgs(), null);
    }
    if (cursor != null) {
  ...
  @NonNull
  @CheckResult
  private Query<RowType, RunReturn> where(
      @NonNull String selection, boolean or, @Nullable Object... selectionArgs) {
  ...
  @NonNull
  @CheckResult
  public Query<RowType, RunReturn> where(
      @NonNull String selection, @Nullable Object... selectionArgs) {
    return where(selection, false, selectionArgs);
  }

  @NonNull
  @CheckResult
  public Query<RowType, RunReturn> orWhere(
      @NonNull String selection, @Nullable Object... selectionArgs) {
  ...
  @NonNull
  @CheckResult
  private Query<RowType, RunReturn> whereIn(
      @NonNull String columnName, boolean or, @Nullable Object... selectionArgs) {
    ...
    final String statement =
        String.format(
            ...
            "%s IN %s",
            columnName,
            Utils.createArgsString(selectionArgs.length));
  ...
  @NonNull
  @CheckResult
  private Query<RowType, RunReturn> whereNotIn(
      @NonNull String columnName, boolean or, @Nullable Object... selectionArgs) {
    if (selectionArgs == null || selectionArgs.length == 0)
      throw new IllegalArgumentException("You must specify non-null, non-empty selection args.");
    final String statement =
  ...
  @NonNull
  @CheckResult
  public Query<RowType, RunReturn> whereIn(
      @NonNull String columnName, @Nullable Object... selectionArgs) {
    return whereIn(columnName, false, selectionArgs);
  }

  @NonNull
  @CheckResult
  public Query<RowType, RunReturn> orWhereIn(
      @NonNull String columnName, @Nullable Object... selectionArgs) {
  ...
  @NonNull
  @CheckResult
  public Query<RowType, RunReturn> whereNotIn(
      @NonNull String columnName, @Nullable Object... selectionArgs) {
  ...
  @NonNull
  @CheckResult
  public Query<RowType, RunReturn> orWhereNotIn(
      @NonNull String columnName, @Nullable Object... selectionArgs) {
  ...
  public Query<RowType, RunReturn> sort(@NonNull String sortOrder) {
    if (this.sortOrder == null) this.sortOrder = new StringBuilder(sortOrder.length());
    else if (this.sortOrder.length() > 0) this.sortOrder.append(", ");
  ...
  public Query<RowType, RunReturn> sortByAsc(@NonNull String... columnNames) {
    if (sortOrder == null) sortOrder = new StringBuilder();
  ...
  private RowType[] getInternal(int limit) {
    ...
    else if (inquiryInstance.context == null) return null;
    if (projection == null) projection = Converter.generateProjection(rowClass);
    ...
    if (contentUri != null) {
      cursor =
          inquiryInstance
              .context
              .getContentResolver()
              .query(contentUri, projection, getWhere(), getWhereArgs(), sort);
    } else {
      if (inquiryInstance._getDatabase() == null)
        throw new IllegalStateException("Database helper was null.");
      else if (tableName == null) throw new IllegalStateException("Table name was null.");
      cursor =
          inquiryInstance
              ._getDatabase()
              .query(tableName, projection, getWhere(), getWhereArgs(), sort);
    }
  ...
  @Nullable
  private Method findWithIdMethod(Class<?> forClass) {
  ...
  public RunReturn run() {
    ...
    final List<FieldDelegate> clsProxies =
        Converter.classFieldDelegates(rowClass, false, builderCls);
    if (tableName == null) throw new IllegalStateException("The table name cannot be null.");
      ...
      switch (queryType) {
        case INSERT:
          ...
          if (builderCls != null) {
            ...
            if (withIdMethod == null) withIdMethod = findWithIdMethod(rowClass);
          ...
          if (inquiryInstance._getDatabase() != null) {
            for (int i = 0; i < values.size(); i++) {
              ...
              RowValues rowValues = Converter.classToValues(row, null, clsProxies, foreignChildren);
              insertedIds[i] =
                  inquiryInstance._getDatabase().insert(tableName, rowValues.toContentValues());
              if (withIdMethod != null) {
        ...
        case UPDATE:
          {
            ...
            if (allHaveIds) {
              ...
              if (getWhere() != null && !getWhere().trim().isEmpty()) {
                throw new IllegalStateException(
                    "You want to update rows which have IDs, "
              ...
              for (RowType row : values) {
                ...
                RowValues rowValues =
                    Converter.classToValues(row, projection, clsProxies, foreignChildren);
                ContentValues values = rowValues.toContentValues();
                if (inquiryInstance._getDatabase() != null) {
                  updatedCount +=
                      inquiryInstance
                          ._getDatabase()
                          .update(tableName, values, "_id = ?", new String[] {rowId + ""});
                } else if (contentUri != null) {
                  updatedCount +=
                      cr.update(contentUri, values, "_id = ?", new String[] {rowId + ""});
                } else throw new IllegalStateException("Database helper was null.");
              }
            ...
            RowValues rowValues =
                Converter.classToValues(firstNotNull, projection, clsProxies, foreignChildren);
            ContentValues values = rowValues.toContentValues();
            if (inquiryInstance._getDatabase() != null) {
              RunReturn value =
                  (RunReturn)
              ...
              return (RunReturn)
                  (Integer) cr.update(contentUri, values, getWhere(), getWhereArgs());
            else throw new IllegalStateException("Database helper was null.");
          }
        case DELETE:
          {
              ...
              RunReturn value =
                  (RunReturn)
                      (Integer)
                          inquiryInstance
                              ._getDatabase()
                              .delete(tableName, getWhere(), getWhereArgs());
  ...
  private void postRun(boolean updateMode, Object row, FieldDelegate proxy) {
    try {
      ...
      FieldDelegate foreignKeyProxy =
          Converter.getProxyByName(
      ...
      if (fldVal != null) {
        if (proxy.getType().isArray())
          ...
          array = (Object[]) fldVal;
        else if (Utils.classImplementsList(proxy.getType())) list = (List) fldVal;
      ...
      if ((array != null && array.length > 0) || (list != null && list.size() > 0)) {
        ...
        if (array != null) {
          for (Object child : array) foreignKeyProxy.set(child, rowId);
        } else {
          for (int i = 0; i < list.size(); i++) foreignKeyProxy.set(list.get(i), rowId);
        }
